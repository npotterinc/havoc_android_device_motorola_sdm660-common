...
FM_LIBS := libqcomfm_jni.so
FM_SYMLINKS := $(addprefix $(TARGET_OUT_APPS)/FMRadioService/lib/arm64/,$(notdir $(FM_LIBS)))
$(FM_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "FMRadioService lib link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /system/lib64/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(FM_SYMLINKS)
